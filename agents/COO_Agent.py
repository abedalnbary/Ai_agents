...
class COOAgent():
    ...
    def __init__(self, llm_client: LlmClient, executor: ToolExecutor, embedder : EmbeddingService, document_store: DocumentStore, config: ReActConfig_COO = ReActConfig_COO(),) -> None:
    ...
    def chat(self, user_input: str) -> str:
        ...
        system = ("You are a COO in Food Manufacturing Company Named **HappyTuna**."
                  "Your email is **coo@happytuna.bitrix**"
                  ...
                  "------------------------------------------------------------------------------"
                  "Actions YOU CAN DO :"
                  "1. Start a backup plan."
                  "2. Move staff and resources."
                  "3. Pause a service."
                  "4. Set priorities."
                  ...
                  "Available tools:"
                  f"{tools_section}"
                  "### forbidden to use 'Check_Inbox' tool again in this session if in past use you found 0 unread emails.")
